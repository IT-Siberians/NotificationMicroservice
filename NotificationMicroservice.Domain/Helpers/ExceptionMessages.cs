namespace NotificationMicroservice.Domain.Helpers
{
    public static class ExceptionMessages
    {
        ...
        public const string ERROR_TEMPLATE_LENGTH = "The length of the message template is invalid. It should be longer than the minimal '{0}' allowed value.";
        public const string ERROR_EMAIL = "Email is not valid. Value is '{0}'.";
        public const string ERROR_NAME_EMPTY_STRING = "{0} cannot null or empty.";
