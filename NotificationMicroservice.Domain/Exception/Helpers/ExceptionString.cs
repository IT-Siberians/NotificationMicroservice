namespace NotificationMicroservice.Domain.Exception.Helpers
{
    public static class ExceptionString
    {
        ...
        public const string ERROR_LANG_CODE_LENGTH = $"Language code not match the encoding.";
        ...
        public const string ERROR_TYPE_NAME_LENGTH = $"Type Name cannot be longer than the maximum allowed value.";
    }
}
