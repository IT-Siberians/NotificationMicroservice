...
{
    public class MessageTemplateRepository : IMessageTemplateRepository<TemplateEntity, Guid>
    {
        ...
        public async Task<IEnumerable<TemplateEntity>> GetAllAsync(CancellationToken cancellationToken, bool asNoTracking = false)
        {
        ...
        public async Task<Guid> AddAsync(TemplateEntity entity, CancellationToken cancellationToken)
        {
        ...
        public async Task<bool> UpdateAsync(TemplateEntity entity, CancellationToken cancellationToken)
        {
            await _context.Templates
                .Where(x => x.Id == entity.Id)
                .ExecuteUpdateAsync(z => z
                    .SetProperty(a => a.TypeId, a => entity.TypeId)
        ...
        public async Task<bool> DeleteAsync(TemplateEntity entity, CancellationToken cancellationToken)
        {
            await _context.Templates
                .Where(x => x.Id == entity.Id)
                .ExecuteUpdateAsync(z => z
